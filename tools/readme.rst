...
Geany is a lightweight, high-performance IDE that supports the Language Server Protocol through the official `Geany Plugins <https://plugins.geany.org/lsp.html>`_ ecosystem using the `geany-lsp <https://github.com/techee/geany-lsp/>`_ module.
